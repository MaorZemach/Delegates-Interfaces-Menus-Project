...
namespace Ex04.Menus.Delegates
{
    public static class MenuItemsBuilder
    {
        ...
        public static ActionItemDelegate CreateActionItem(string i_ActionName, ActionInvoker i_EventHandler)
        {
            ActionItemDelegate newActionItem;
            newActionItem = new ActionItemDelegate(i_ActionName, i_EventHandler);
