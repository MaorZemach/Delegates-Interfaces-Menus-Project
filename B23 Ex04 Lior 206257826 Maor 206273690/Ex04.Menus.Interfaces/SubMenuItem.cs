    ...
    public class SubMenuItem : MenuItem
    {
        ...
        internal override void ExecuteUserActionChoice()
        {
            ...
            while (convertedUserInput != exitOrBackAction)
            {
                ...
                {
                    item.PrintMenuName(menuItemIdx);
                    ++menuItemIdx;
                }
                ...
                Console.Clear();
                r_MenuItemsList[convertedUserInput].ExecuteUserActionChoice();
            }
        }
